...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50 dark:bg-[#0f172a] text-slate-900 dark:text-slate-100 transition-colors duration-300">
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 w-64 glass border-r transform transition-transform duration-300 ease-in-out",
      ...
      <main className="flex-1 flex flex-col overflow-hidden lg:ml-64">
        ...
        {/* Mobile Header */}
        <header className="lg:hidden p-4 flex items-center justify-between glass border-b border-slate-200 dark:border-slate-800">
